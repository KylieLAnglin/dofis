...
desc_yr1718 = pd.read_csv((os.path.join(data_path, 'tea', 'desc_yr1819.csv')))

desc_long = pd.concat([desc_yr1112, desc_yr1213, desc_yr1314, desc_yr1415, desc_yr1516, desc_yr1617, desc_yr1718], sort = True)
