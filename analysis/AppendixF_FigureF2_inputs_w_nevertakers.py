...
uncertified_agg = pd.read_excel(
    start.TABLE_PATH + "results_w_nevertakers_uncertified_ag_raw_average.xlsx"
)
out_of_field_agg = pd.read_excel(
    start.TABLE_PATH + "results_w_nevertakers_out_of_field_ag_raw_average.xlsx"
)
class_size_agg = pd.read_excel(
    start.TABLE_PATH + "results_w_nevertakers_class_size_elem_ag_raw_average.xlsx"
)
ratio_agg = pd.read_excel(
    start.TABLE_PATH + "results_w_nevertakers_stu_teach_ratio_ag_raw_average.xlsx"
)
