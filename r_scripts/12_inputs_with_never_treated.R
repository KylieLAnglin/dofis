...
file_name = paste(output_path, "results_never_inputs_raw.xlsx", sep = "")
...
file_name = paste(output_path, "results_never_uncertified_disag_raw.xlsx", sep = "")
wb <- loadWorkbook(file_name)
...
file_name = paste(output_path, "results_never_uncertified_ag_raw.xlsx", sep = "")
wb <- loadWorkbook(file_name)
...
disag.results <- data.frame(disag$group, disag$t, disag$att, disag$se, disag$n)
file_name = paste(output_path, "results_never_outoffield_math_disag_raw.xlsx", sep = "")
wb <- loadWorkbook(file_name)
writeData(wb, sheet = "raw" , disag.results, colNames = TRUE)
saveWorkbook(wb,file_name,overwrite = T)
...
agg.results <- data.frame(agg.simple$overall.att, agg.simple$overall.se, agg.dynamic$egt, agg.dynamic$att.egt, agg.dynamic$se.egt)
file_name = paste(output_path, "results_never_outoffield_math_ag_raw.xlsx", sep = "")
wb <- loadWorkbook(file_name)
writeData(wb, sheet = "raw" , agg.results, colNames = TRUE)
saveWorkbook(wb,file_name,overwrite = T)
...
disag.results <- data.frame(disag$group, disag$t, disag$att, disag$se, disag$n)
file_name = paste(output_path, "results_never_outoffield_science_disag_raw.xlsx", sep = "")
wb <- loadWorkbook(file_name)
writeData(wb, sheet = "raw" , disag.results, colNames = TRUE)
saveWorkbook(wb,file_name,overwrite = T)
...
agg.results <- data.frame(agg.simple$overall.att, agg.simple$overall.se, agg.dynamic$egt, agg.dynamic$att.egt, agg.dynamic$se.egt)
file_name = paste(output_path, "results_never_outoffield_science_ag_raw.xlsx", sep = "")
wb <- loadWorkbook(file_name)
writeData(wb, sheet = "raw" , agg.results, colNames = TRUE)
saveWorkbook(wb,file_name,overwrite = T)
...
disag.results <- data.frame(disag$group, disag$t, disag$att, disag$se, disag$n)
file_name = paste(output_path, "results_never_outoffield_cte_disag_raw.xlsx", sep = "")
wb <- loadWorkbook(file_name)
writeData(wb, sheet = "raw" , disag.results, colNames = TRUE)
saveWorkbook(wb,file_name,overwrite = T)
...
agg.results <- data.frame(agg.simple$overall.att, agg.simple$overall.se, agg.dynamic$egt, agg.dynamic$att.egt, agg.dynamic$se.egt)
file_name = paste(output_path, "results_never_outoffield_cte_ag_raw.xlsx", sep = "")
wb <- loadWorkbook(file_name)
writeData(wb, sheet = "raw" , agg.results, colNames = TRUE)
saveWorkbook(wb,file_name,overwrite = T)
...
disag.results <- data.frame(disag$group, disag$t, disag$att, disag$se, disag$n)
file_name = paste(output_path, "results_never_class_size_elem_disag_raw.xlsx", sep = "")
wb <- loadWorkbook(file_name)
writeData(wb, sheet = "raw" , disag.results, colNames = TRUE)
saveWorkbook(wb,file_name,overwrite = T)
...
agg.results <- data.frame(agg.simple$overall.att, agg.simple$overall.se, agg.dynamic$egt, agg.dynamic$att.egt, agg.dynamic$se.egt)
file_name = paste(output_path, "results_never_class_size_elem_ag_raw.xlsx", sep = "")
wb <- loadWorkbook(file_name)
writeData(wb, sheet = "raw" , agg.results, colNames = TRUE)
saveWorkbook(wb,file_name,overwrite = T)
