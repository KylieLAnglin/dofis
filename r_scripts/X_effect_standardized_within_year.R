...
file_name = paste(output_path, "results_math_disag_raw_std.xlsx", sep = "")
...
file_name = paste(output_path, "results_math_ag_raw_std.xlsx", sep = "")
wb <- loadWorkbook(file_name)
...
disag.reading <- att_gt(yname = "reading",
                        gname = "group",
                        idname = "campus",
                        tname = "year",
                        xformla = ~1,
...
file_name = paste(output_path, "results_reading_disag_raw_std.xlsx", sep = "")
wb <- loadWorkbook(file_name)
...
file_name = paste(output_path, "results_reading_ag_raw_std.xlsx", sep = "")
wb <- loadWorkbook(file_name)
