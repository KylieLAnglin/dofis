...
file_name = "/Users/kylie/dofis/results/Who Needs Rules/results_math_disag_raw_matching.xlsx"
...
file_name = "/Users/kylie/dofis/results/Who Needs Rules/results_math_ag_raw_matching.xlsx"
wb <- loadWorkbook(file_name)
...
disag.reading <- att_gt(yname = "reading_yr15std",
                     ...
                     idname = "campus",
                     tname = "year",
                     xformla = ~1 + pre_num + pre_hisp + + pre_frpl + pre_sped + pre_ell + pre_white + pre_black + pre_tenure + pre_frpl + pre_turnover,
                     data = df,
                     control_group = c("notyettreated"), 
                     est_method = "reg",
                     allow_unbalanced_panel = TRUE,
...
file_name = "/Users/kylie/dofis/results/Who Needs Rules/results_reading_disag_raw_matching.xlsx"
wb <- loadWorkbook(file_name)
...
file_name = "/Users/kylie/dofis/results/Who Needs Rules/results_reading_ag_raw_matching.xlsx"
wb <- loadWorkbook(file_name)
