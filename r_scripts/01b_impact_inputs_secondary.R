...
run_and_export_main(df = df, outcome = "teachers_exp_ave", disag_file = "results_teachers_exp_ave_disag_raw_average.xlsx", ag_file = "results_teachers_exp_ave_ag_raw_average.xlsx")
...
run_and_export_main(df = rural, outcome = "teachers_exp_ave", disag_file = "results_teachers_exp_ave_disag_raw_rural.xlsx", ag_file = "results_teachers_exp_ave_ag_raw_rural.xlsx")
...
run_and_export_main(df = urban, outcome = "teachers_exp_ave", disag_file = "results_teachers_exp_ave_disag_raw_urban.xlsx", ag_file = "results_teachers_exp_ave_ag_raw_urban.xlsx")
...
run_and_export_main(df = hispanic, outcome = "teachers_exp_ave", disag_file = "results_teachers_exp_ave_disag_raw_hispanic.xlsx", ag_file = "results_teachers_exp_ave_ag_raw_hispanic.xlsx")
...
run_and_export_main(df = black, outcome = "teachers_exp_ave", disag_file = "results_teachers_exp_ave_disag_raw_black.xlsx", ag_file = "results_teachers_exp_ave_ag_raw_black.xlsx")
...
run_and_export_main(df = frpl, outcome = "teachers_exp_ave", disag_file = "results_teachers_exp_ave_disag_raw_frpl.xlsx", ag_file = "results_teachers_exp_ave_ag_raw_frpl.xlsx")
...
run_and_export_main(df = avescore, outcome = "teachers_exp_ave", disag_file = "results_teachers_exp_ave_disag_raw_avescore.xlsx", ag_file = "results_teachers_exp_ave_ag_raw_avescore.xlsx")
