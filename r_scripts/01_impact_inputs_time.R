...
run_and_export_main(df = df, outcome = "minutes", disag_file = "results_days_before_third_week_disag_raw_average.xlsx", ag_file = "results_days_before_third_week_ag_raw_average.xlsx")
